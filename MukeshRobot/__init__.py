...
if ENV:
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "sahi_kzx")
    ...
    try:
        DRAGONS = set(int(x) for x in os.environ.get("DRAGONS", "7000670346").split())
        DEV_USERS = set(int(x) for x in os.environ.get("DEV_USERS", "7000670346").split())
    except ValueError:
